          ...
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel33">Saque</h4>
                <button type="button" class="close" data-bs-dismiss="modal"
                        aria-label="Close">
                  <i data-feather="x"></i>
                </button>
              </div>
              <form action="<%=request.getContextPath()%>/ServletUser?action=withdraw&id=${loggedUserId.id}" method="post">
                <div class="modal-body">
                  <label>Valor que deseja sacar: </label>
                  <div class="form-group">
                    <input type="text" placeholder="Valor"
                           class="form-control" id="value" name="withdrawValue">
                  </div>
                </div>
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-success ml-1"
                    ...
                    <span class="d-none d-sm-block">Sacar</span>
                  </button>
                </div>
              </form>
            </div>
